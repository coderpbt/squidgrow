        ...
        <div className="overflow-hidden py-14">
            <div className='custom-container'>
                <div className='text-center relative z-20'> 
                    <h2 className='font-bold text-[81px] leading-20 font-clash mb-7 max-lg:text-[65px] max-md:text-[45px]'>The Community</h2>
                    <p className='text-secondary font-normal text-lg leading-7 w-[49%] mx-auto py-10 max-lg:w-[80%] max-md:w-[95%]'>Empowering our community is at the heart of SquidGrows philosophy.Through a user-centric approach, we prioritize your needs, ideas, and feedback, cultivating a dynamic community that propels the platforms evolution in the ever-changing crypto landscape </p>
                ...
                <div className="grid grid-cols-3 gap-5 mt-16 max-md:grid-cols-1">
                    <div className="text-center">
                        <h2 className="text-primary font-bold text-[70px] leading-20 font-clash">+23k</h2>
                        <h4 className="text-3xl font-semibold leading-16 text-white">Holders</h4>
                    </div>
                    <div className="text-center">
                        <h2 className="text-primary font-bold text-[70px] leading-20 font-clash">+500k</h2>
                        <h4 className="text-3xl font-semibold leading-16 text-white">Transactions</h4>
                    </div>
                    <div className="text-center">
                        <h2 className="text-primary font-bold text-[70px] leading-20 font-clash">70.3M</h2>
