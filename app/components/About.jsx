    ...
    <div className="overflow-hidden">
      <div className="custom-container">
        <div className="bg-[url(/images/about.png)] rounded-[64px] bg-cover bg-no-repeat bg-center max-w-[1407px] mx-auto py-12 ">
            ...
            <h2 className='font-bold lg:text-[45px] w-[45%] leading-14 font-clash'>Introducing SilentSwap: The Ultimate Privacy.</h2>
            <p className='text-secondary font-normal text-lg leading-7 w-[35%] py-10'>Seamless swaps, ultimate privacy, and cross-chain freedom. Unlock the future of trading now. Seamless swaps, ultimate privacy, and cross-chain freedom. Unlock the future of trading now.</p>
