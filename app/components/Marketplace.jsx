      ...
      <div className="overflow-hidden py-14">
            <div className='custom-container'>
                <div className='text-center'> 
                  <h2 className='font-bold lg:text-[55px] leading-20 font-clash'>SquidGrow Ecosystem</h2>
                  <p className='text-secondary font-normal text-lg leading-7 w-[46%] mx-auto py-7'> SquidGrows Ecosystem has multiple products including a DEX, NFT Marketplace, & Liquidity Locker.</p>
                </div>
                <div className="grid grid-cols-3 gap-6 mt-7">
                  ...
                  <div className="bg-[#151515] pt-5 pb-8 rounded-[28px] hover:shadow-[0px_4px_69px_0px_#6015ec] transition duration-300 group">
                     ...
                     <h2 className='pl-10 pb-3.5 pr-10 font-bold lg:text-[42px] leading-20 font-clash'>SilentSwap</h2>
                  ...
                  <div className="bg-[#151515] pt-5 pb-8 rounded-[28px] hover:shadow-[0px_4px_69px_0px_#6015ec] transition duration-300 group">
                     ...
                     <hr className="border-[#646464]" />
                     <h2 className='pl-10 pb-3.5 pr-10 font-bold lg:text-[42px] leading-20 font-clash'>SGS</h2>
                  ...
                  <div className="bg-[#151515] pt-5 pb-8 rounded-[28px] hover:shadow-[0px_4px_69px_0px_#6015ec] transition duration-300 group">
                     ...
                     <hr className="border-[#646464]" />
                     <h2 className='pl-10 pb-3.5 pr-10 font-bold lg:text-[42px] leading-20 font-clash'>Inkubate</h2>
